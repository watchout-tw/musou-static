webpackJsonp([1],Array(42).concat([
/* 42 */
...
/* harmony default export */ __webpack_exports__["a"] = ({
  methods: {
    markdown: function markdown(str) {
      return __WEBPACK_IMPORTED_MODULE_0_marked___default()(str);
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  references: ['考選部1993年警察特考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/082/018000c104.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/082/33448s.pdf)', '考選部1994年國安局特考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/083/013000c084.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/083/15604s.pdf)', '考選部1994年專門職業及技術人員普考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/083/033000c164.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/083/15659s.pdf)', '考選部1992年專門職業及技術人員普考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/081/001000c144.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/Answer//081010_81%E5%B9%B4%E6%B8%AC%E9%A9%97%E9%A1%8C%E7%AD%94%E6%A1%88.pdf)', '考選部1994年航海人員、漁船船員、船舶電信人員特考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/083/030000c064.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/083/15652s.pdf)', '考選部1993年司法政風人員特考[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/082/023000c084.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/082/33464s.pdf)', '考選部1993年全國公務人員普通考試[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/082/016000c034.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/ModifyAnswer/082/15059m.pdf)', '考選部1996年高等暨普通中醫師檢定考試[試題](http://wwwc.moex.gov.tw/ExamQuesFiles/Question/085/006000c124.pdf)及[答案](http://wwwc.moex.gov.tw/ExamQuesFiles/StandardAnswer/085/16533s.pdf)', '大考中心1994年學測社會科[試題](http://www.ceec.edu.tw/AbilityExam/AbilityExamPaper/83SAT_Paper/83%E5%B9%B4%E5%AD%B8%E6%B8%AC%E7%A4%BE%E6%9C%83%E7%A7%91.pdf)及[答案](http://www.ceec.edu.tw/AbilityExam/AbilityExamPaper/83SAT_Paper/83%E5%B9%B4%E5%AD%B8%E6%B8%AC%E7%AD%94%E6%A1%88.pdf)', '大考中心1995年學測社會科[試題](http://www.ceec.edu.tw/AbilityExam/AbilityExamPaper/84SAT_Paper/84%E5%B9%B4%E5%AD%B8%E6%B8%AC%E7%A4%BE%E6%9C%83%E7%A7%91.pdf)及[答案](http://www.ceec.edu.tw/AbilityExam/AbilityExamPaper/84SAT_Paper/84%E5%B9%B4%E5%AD%B8%E6%B8%AC%E7%AD%94%E6%A1%88.pdf)']
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  references: ['[全國法規資料庫](http://law.moj.gov.tw)']
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  references: ['《走過長夜：政治受難者的生命故事》（輯一･秋蟬的悲鳴、輯二･看到陽光的時候、輯三･換不回的青春，共三冊）。新北市：國家人權博物館籌備處，2015。', '《冤獄、求生與揚名——政治受難者歐陽劍華與張常美的生命故事特展專刊》。新北市：國家人權博物館籌備處，2015。', '國家人權博物館籌備處網站／影音書籍成果／電子書', '台灣民間真相與和解促進會網站／歷史真相／歷史之牆／白色恐怖･被槍決部分名單', '陳順孝，《新聞控制與反控制：「記實避禍」的報導策略》。台北：五南出版社，2003。', '國立公共資訊圖書館／數位典藏服務網']
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  tally: {
    country: {
      id: 'country',
      name: 'country',
      condition: function condition(str) {
...
"use strict";
/* unused harmony export TOGGLE_IS_AUTHENTICATED */
/* unused harmony export TOGGLE_MODAL_AUTH */
/* unused harmony export TOGGLE_MODAL_RESET_PASSWORD */
/* unused harmony export TOGGLE_MODAL_IDENTITY */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CACHE_REPS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return CACHE_PARTIES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return CACHE_CAUCUSES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return CACHE_GOV_AGENCIES; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return CACHE_LEGISLATIVE_STEPS; });

var TOGGLE_IS_AUTHENTICATED = 'toggleIsAuthenticated';
var TOGGLE_MODAL_AUTH = 'toggleModalAuth';
var TOGGLE_MODAL_RESET_PASSWORD = 'toggleModalResetPassword';
var TOGGLE_MODAL_IDENTITY = 'toggleModalIdentity';

var CACHE_REPS = 'cacheReps';
var CACHE_PARTIES = 'cacheParties';
var CACHE_CAUCUSES = 'cacheCaucuses';
var CACHE_GOV_AGENCIES = 'cacheGovAgencies';
...
var routerViews = {
  journey: __WEBPACK_IMPORTED_MODULE_7__components_Journey___default.a,
  swipe: __WEBPACK_IMPORTED_MODULE_8__components_Swipe___default.a,
  longform: __WEBPACK_IMPORTED_MODULE_9__components_LongForm___default.a,
  draw: __WEBPACK_IMPORTED_MODULE_10__components_Draw___default.a,
  map: __WEBPACK_IMPORTED_MODULE_11__components_Map___default.a
};
...
try {
  for (var _iterator = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(menu), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    var series = _step.value;

    routes.push({
      path: '/' + series.id,
      component: __WEBPACK_IMPORTED_MODULE_6__components_Series___default.a,
      props: {
        config: series
      }
    });
    ...
    try {
      for (var _iterator2 = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(series.pages), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        routes.push({
          ...
          props: {
            config: __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(page, { seriesTitle: series.title })
          }
        });
      }
    } catch (err) {
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
var defaultDarkBackgroundColor = '#333';
var defaultLightTextColor = '#efefef';

var defaultDarkTextColor = '#333';
...
/* harmony default export */ __webpack_exports__["default"] = ({
  sequence: {
    ...
    media: [{
      ...
      type: 'audio',
      url: 'https://watchout.tw/musou-aux/modern-history-of-taiwan/Imperial_Rescript_on_the_Termination_of_the_War-excerpt.mp3?l=20s' }, {
    ...
    scenes: [{
      ...
      subtitle: ['這就是天皇的聲音？', '戰爭終於要結束了嗎？', '總算不再是殖民地', '台灣人能做自己的主人了吧？'],
      backgroundAudio: {
        id: 'japanese-surrender-broadcast'
      },
      default: {
      ...
      subtitle: ['前幾天，陳儀宣布台北戒嚴', '廣播說不會傷害守法民眾，會保護人民', '大家也正在組成委員會跟陳儀談判', '討論如何讓民眾安心', '這幾日街頭仍不斷傳來間歇的槍聲', '聽說中國兵從基隆上岸', '《民報》也停刊了', '不知道他們還好嗎？']
    }, {
      id: '林茂生',
      classes: ['square'],
      mainVisual: {
      ...
      subtitle: ['誰能料想三月會做洪水！', '那突發的巨浪，沖破了那堅固的防堤。', '那無情的巨浪，流失了那美麗的田園。', '那激怒的巨浪，淹沈了那平和的城市。', '誰能料想三月會做洪水！', '有一位勇敢的青年，曾有過洋的經驗，', '未到防堤就被狂浪捲沒去了。', '有一位理智的青年，抱有新進的理論，', '未到田園就被泥海埋沒去了。', '有一位熱血的青年，吐露無限的純情，', '未到城市就被崩山壓沒去了。', '誰能料想三月會做洪水！', '洪水一過，滿地平坡！', '洪水一過，族親四散！', '洪水一過，人心如灰！', '誰能料想三月會做洪水！', '國家何時再建？', '民族何時復興？', '社會何時改革？'],
      mainVisual: {
        type: 'image',
        url: 'another-future-dark.jpg',
        width: 2400,
  ...
  references: ['二二八事件紀念基金會', '中研院台灣史研究所台灣日記知識庫', '國立公共資訊圖書館數位典藏服務網', '國史館臺灣文獻館臺灣省行政長官公署檔案']
});
...
/* harmony default export */ __webpack_exports__["a"] = ({
  methods: {
    playAudio: function playAudio(el) {
      el.currentTime = 0.0;
      el.volume = 1.0;
      el.play();
    },
    fadeOutAudio: function fadeOutAudio(el, callback) {
...
/* harmony default export */ __webpack_exports__["a"] = ({
  methods: {
    ...
    tokenize: function tokenize(sentence) {
      var _this = this;

      var addSpaceBack = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      var segments = __WEBPACK_IMPORTED_MODULE_0_pangu___default.a.spacing(sentence.toUpperCase()).split(' ');
      if (addSpaceBack) {
      ...
      return segments.map(function (segment) {
        if (_this.isLatin(segment) === false) {
...
var localActions = {
  cacheReps: function cacheReps(_ref) {
    var commit = _ref.commit;

    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/c0ngress/reps').then(function (response) {
      commit(__WEBPACK_IMPORTED_MODULE_2__mutation_types__["a" /* CACHE_REPS */], {
        data: response.data.rows
      });
    });
  },
  cacheParties: function cacheParties(_ref2) {
    var commit = _ref2.commit;

    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/c0ngress/parties').then(function (response) {
      commit(__WEBPACK_IMPORTED_MODULE_2__mutation_types__["b" /* CACHE_PARTIES */], {
        data: response.data.rows.map(function (row) {
          return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(row, {
            code: row.emblem,
            colors: [row.color]
          });
        }) });
  ...
  cacheCaucuses: function cacheCaucuses(_ref3) {
    var commit = _ref3.commit;

    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/c0ngress/caucuses').then(function (response) {
      commit(__WEBPACK_IMPORTED_MODULE_2__mutation_types__["c" /* CACHE_CAUCUSES */], {
        data: response.data.rows
      });
    });
  },
  cacheGovAgencies: function cacheGovAgencies(_ref4) {
    var commit = _ref4.commit;

    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/c0ngress/gov_agencies').then(function (response) {
      commit(__WEBPACK_IMPORTED_MODULE_2__mutation_types__["d" /* CACHE_GOV_AGENCIES */], {
        data: response.data.rows
      });
    });
  },
  cacheLegislativeSteps: function cacheLegislativeSteps(_ref5) {
    var commit = _ref5.commit;

    __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('/c0ngress/legislative_steps').then(function (response) {
      commit(__WEBPACK_IMPORTED_MODULE_2__mutation_types__["e" /* CACHE_LEGISLATIVE_STEPS */], {
        data: response.data.rows
      });
    });
  }
...
var localMutations = (_localMutations = {}, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_localMutations, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["a" /* CACHE_REPS */], function (state, mutateObj) {
  __WEBPACK_IMPORTED_MODULE_4_vue__["a" /* default */].set(state.cache, 'reps', mutateObj.data);
}), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_localMutations, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["b" /* CACHE_PARTIES */], function (state, mutateObj) {
  __WEBPACK_IMPORTED_MODULE_4_vue__["a" /* default */].set(state.cache, 'parties', mutateObj.data);
}), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_localMutations, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["c" /* CACHE_CAUCUSES */], function (state, mutateObj) {
  __WEBPACK_IMPORTED_MODULE_4_vue__["a" /* default */].set(state.cache, 'caucuses', mutateObj.data);
}), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_localMutations, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["d" /* CACHE_GOV_AGENCIES */], function (state, mutateObj) {
  __WEBPACK_IMPORTED_MODULE_4_vue__["a" /* default */].set(state.cache, 'gov_agencies', mutateObj.data);
}), __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_defineProperty___default()(_localMutations, __WEBPACK_IMPORTED_MODULE_3__mutation_types__["e" /* CACHE_LEGISLATIVE_STEPS */], function (state, mutateObj) {
  __WEBPACK_IMPORTED_MODULE_4_vue__["a" /* default */].set(state.cache, 'legislative_steps', mutateObj.data);
}), _localMutations);
...
var LOGIN_SUCCESS = 2;
var REQUIRE_EMAIL_VERIF = 3;

/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'modal-auth',
  mixins: [__WEBPACK_IMPORTED_MODULE_3__interfaces_accordion__["a" /* default */], __WEBPACK_IMPORTED_MODULE_4__interfaces_modal__["a" /* default */]],
  data: function data() {
    return {
      modal: {
        key: 'Auth'
      ...
      dataStore: __WEBPACK_IMPORTED_MODULE_2__lib_dataStore__["a" /* default */],
  ...
  computed: {
    activeCardID: function activeCardID() {
  ...
  methods: {
    ...
    onJoinSuccessful: function onJoinSuccessful(response) {
      this.verificationEmailSent = true;
      this.hideAfter(3500);
    },
    onLoginSuccessful: function onLoginSuccessful(response) {
      ...
      localStorage.setItem('watchout-citizen-roles', __WEBPACK_IMPORTED_MODULE_1__lib_util__["d" /* makeCitizenRoleString */](response.data.roles));

      __WEBPACK_IMPORTED_MODULE_1__lib_util__["e" /* authenticateAxios */]();
      __WEBPACK_IMPORTED_MODULE_1__lib_util__["f" /* getCitizen */](this.$store);
    ...
    showLostPwd: function showLostPwd() {
    ...
    showFacebookLogin: function showFacebookLogin() {
      __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_no_facebook');
    },
    generateRandomHandle: function generateRandomHandle(event) {
    ...
    join: function join(event) {
      ...
      if (!(this.joinEmail && this.joinHandle && this.joinPassword)) {
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_join_info_incomplete');
        return;
      }
      if (!this.iAgree) {
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_tos_agreement_required');
        return;
      }
      var citizen = {
      ...
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/auth/join', citizen).then(function (response) {
        _this.onJoinSuccessful(response);
      }).catch(function (error) {
        _this.clearInputFields();
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["b" /* handleThatErrorAndAlert */](error);
      });
    },
    login: function login() {
      ...
      if (!(this.loginAccount && this.loginPassword)) {
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_login_info_incomplete');
        return;
      }

      var loginObj = /^.+@.+$/.test(this.loginAccount) ? { email: this.loginAccount } : { handle: this.loginAccount };
      loginObj.password = this.loginPassword;
      __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/auth/login', loginObj).then(function (response) {
        _this2.onLoginSuccessful(response);
      }).catch(function (error) {
        _this2.clearInputFields();
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["g" /* handleThatError */](error);
        if (error.response.data.message.indexOf('未認證') > -1 && error.response.data.link) {
          _this2.emailVerificationRequestLink = error.response.data.link.replace(__WEBPACK_IMPORTED_MODULE_0_axios___default.a.defaults.baseURL, '');
          _this2.requireEmailVerification = true;
        } else {
          __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */](error.response.data.message);
        }
      });
    },
    requestEmailVerification: function requestEmailVerification() {
      var _this3 = this;

      if (this.emailVerificationRequestLink) {
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get(this.emailVerificationRequestLink).then(function (response) {
          _this3.verificationEmailSent = true;
          _this3.hideAfter(3500);
        }).catch(__WEBPACK_IMPORTED_MODULE_1__lib_util__["g" /* handleThatError */]);
      }
    }
  }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__interfaces_modal__ = __webpack_require__(43);




/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__interfaces_modal__["a" /* default */]],
  data: function data() {
    return {
      modal: {
        key: 'Identity'
  ...
  computed: {
    ...
    firstEmail: function firstEmail() {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_axios___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_axios__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__lib_util__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__interfaces_modal__ = __webpack_require__(43);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_2__interfaces_modal__["a" /* default */]],
  data: function data() {
    return {
      modal: {
        key: 'LostPwd'
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      if (this.registrationEmail && /^.+@.+$/.test(this.registrationEmail)) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/citizen/request_reset_password', body).then(function (response) {
          _this.submitted = true;
          _this.hideAfter(2500);
        }).catch(function (error) {
          _this.clearInputFields();
          __WEBPACK_IMPORTED_MODULE_1__lib_util__["b" /* handleThatErrorAndAlert */](error);
        });
      } else {
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_email_addr_not_valid');
      }
    }
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    submit: function submit() {
      ...
      var token = localStorage.getItem('watchout-password-reset-token');
      if (token) {
        if (this.newPassword && this.confirmPassword === this.newPassword) {
          ...
          __WEBPACK_IMPORTED_MODULE_0_axios___default.a.post('/citizen/reset_password', data, {
            headers: headers
          ...
          __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_reset_pwd_input_mismatch');
        }
      } else {
        __WEBPACK_IMPORTED_MODULE_1__lib_util__["c" /* sysAlert */]('park_auth_token_not_found');
      }
    }
  }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_vuex__ = __webpack_require__(154);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__lib_util__ = __webpack_require__(44);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    channelButtonClasses: function channelButtonClasses() {
      var classes = [];
      if (this.menu) {
    ...
    identityButtonClasses: function identityButtonClasses() {
  ...
  created: function created() {
    ...
    if (this.isAuthenticated) {
      __WEBPACK_IMPORTED_MODULE_2__lib_util__["f" /* getCitizen */](this.$store);
    }
  },
  ...
  methods: {
    ...
    toggleModalAuth: function toggleModalAuth() {
      if (__WEBPACK_IMPORTED_MODULE_2__lib_util__["a" /* jwtTokenIsHere */]()) {
...
var supportPackages = {
  ...
  musou: {
    channel: 'musou',
    link: __WEBPACK_IMPORTED_MODULE_0__lib_dataStore__["a" /* default */].links.support.watchout.custom,
    text: ['請支持我們做更多有意義的專題', '因為很缺錢，真的很缺。'],
    image: 'farmer_hat',
    button: '支持沃草，成為草民'
  },
  lab: {
    channel: 'lab',
    link: __WEBPACK_IMPORTED_MODULE_0__lib_dataStore__["a" /* default */].links.support.watchout.direct,
    text: ['更多法案拆解、議事紀錄分析', '需要你的幫助。'],
    image: 'pitcher',
    button: '支持沃草，灌溉議題'
  }
};
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    modalAuthIsShown: function modalAuthIsShown() {
      return this.$store.state.modalAuthIsShown;
    },
    modalLostPwdIsShown: function modalLostPwdIsShown() {
      return this.$store.state.modalLostPwdIsShown;
    },
    modalResetPwdIsShown: function modalResetPwdIsShown() {
      return this.$store.state.modalResetPwdIsShown;
    },
    modalIdentityIsShown: function modalIdentityIsShown() {
      return this.$store.state.modalIdentityIsShown;
    },
    modalTermsOfSvcIsShown: function modalTermsOfSvcIsShown() {
  ...
  created: function created() {
    console.log('This is the Musou App (' + __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].config.mode + ')');
    if (__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].config.mode === 'production') {
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.baseURL = 'https://core.watchout.tw';
    } else if (__WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].config.mode === 'staging') {
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.baseURL = 'https://staging.core.watchout.tw';
    } else {
      __WEBPACK_IMPORTED_MODULE_2_axios___default.a.defaults.baseURL = 'https://dev.core.watchout.tw';
    }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__interfaces_knowsMarkdown__["a" /* default */]],
  ...
  components: {
    LineChart: __WEBPACK_IMPORTED_MODULE_1__draw_LineChart___default.a
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SeriesMenu: __WEBPACK_IMPORTED_MODULE_0__components_SeriesMenu___default.a
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  metaInfo: function metaInfo() {
    return {
      ...
      meta: [{
        vmid: 'og-image',
        property: 'og:image',
        content: __webpack_require__(42)("./" + this.ogImage)
      }]
    };
  },
  ...
  data: function data() {
    ...
    return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()(config, state);
  },

  watch: {
    activeSceneIndex: function activeSceneIndex() {
  ...
  computed: {
    ...
    activeSceneClasses: function activeSceneClasses() {
      return this.activeScene.classes;
    },
    activeSceneDate: function activeSceneDate() {
      return this.activeScene.date ? new Date(this.activeScene.date) : undefined;
    },
    activeSceneDateString: function activeSceneDateString() {
    ...
    activeSceneCountDown: function activeSceneCountDown() {
      var result = null;
      if (this.activeSceneDate && this.sequence.endDate) {
        var endDate = new Date(this.sequence.endDate);
    ...
    mainVisualContentStyles: function mainVisualContentStyles() {
      ...
      if (this.mainVisual && this.mainVisual.type === 'image') {
        ...
        styles.backgroundImage = 'url(' + __webpack_require__(42)("./" + this.mainVisual.url) + ')';
      }
      return styles;
    },
    mainVisualContainerStyles: function mainVisualContainerStyles() {
      return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()(this.getStyles('mainVisualContainer'), {
        transformOrigin: this.canvas.transformOrigin.x + '% ' + this.canvas.transformOrigin.y + '%',
        transform: 'scale(' + this.canvas.transform.scale + ')'
      });
    },
    visualTagContainerStyles: function visualTagContainerStyles() {
    ...
    textContainerStyles: function textContainerStyles() {
    ...
    nextScene: function nextScene() {
      var index = -1;
      if (this.activeScene.classes.includes('fork')) {} else {
        index = this.activeScene.hasOwnProperty('next') ? this.getSceneIndexFromID(this.activeScene.next) : (this.activeSceneIndex + this.scenes.length + 1) % this.scenes.length;
      }
      return index > 0 && index < this.scenes.length ? this.scenes[index] : undefined;
    },
    backgroundAudioLibrary: function backgroundAudioLibrary() {
      var _this = this;

      var backgroundAudioAtScene = this.scenes.filter(function (scene) {
        return scene.hasOwnProperty('backgroundAudio');
      }).map(function (scene) {
        return {
      ...
      return [].concat(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_toConsumableArray___default()(new __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_set___default.a(backgroundAudioAtScene.map(function (item) {
        return item.mediaID;
      })))).map(function (mediaID) {
        return {
          media: _this.getMediaFromID(mediaID),
          scenes: backgroundAudioAtScene.filter(function (item) {
  ...
  methods: {
    getMediaFromID: function getMediaFromID(id) {
      return __WEBPACK_IMPORTED_MODULE_4_babel_runtime_core_js_object_assign___default()({}, this.sequence.media.find(function (media) {
        return media.id === id;
      }));
    },
    getSceneIndexFromID: function getSceneIndexFromID(id) {
      return this.sceneIDs.indexOf(id);
    },
    canvasIsLarger: function canvasIsLarger() {
      return this.canvas.width >= this.mainVisual.width && this.canvas.height >= this.mainVisual.height;
    },
    getPositions: function getPositions(name, data) {
      return {
        top: data.y * 100.0 / this.mainVisual.height + '%',
        left: data.x * 100.0 / this.mainVisual.width + '%'
      };
    },
    getDimensions: function getDimensions(name, data) {
      var styles = {};
      styles.width = data.width * this.zoom + 'px';
      styles.height = data.height * this.zoom + 'px';
      return styles;
    },
    getVisibility: function getVisibility(data) {
      var styles = {};
    ...
    getStyles: function getStyles(name) {
      ...
      var styles = {};
      var global = this.sequence.default ? this.sequence.default.styles ? this.sequence.default.styles[name] : undefined : undefined;
      var scene = this.activeScene.default ? this.activeScene.default.styles ? this.activeScene.default.styles[name] : undefined : undefined;
      var local = data ? data.styles : undefined;
      var attributes = ['text', 'border', 'background'];
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_get_iterator___default()(attributes), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      if (styles.text && __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(styles.text) === 'object') {
      ...
      if (styles.border && __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(styles.border) === 'object') {
      ...
      if (styles.background && __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_typeof___default()(styles.background) === 'object') {
        var color = __WEBPACK_IMPORTED_MODULE_8_parse_color___default()(styles.background.color);
        if (styles.background.opacity) {
          color = __WEBPACK_IMPORTED_MODULE_8_parse_color___default()('rgba(' + color.rgb.slice().concat(styles.background.opacity).join(',') + ')');
        }
        styles.backgroundColor = 'rgba(' + color.rgba.join(',') + ')';
      }
      return styles;
    },
    setSceneDimensions: function setSceneDimensions() {
      var el = document.getElementById('journey-main-visual-canvas');
      if (el) {
        ...
        if (this.mainVisual && this.mainVisual.type === 'image') {
          var originalRatio = this.mainVisual.width / this.mainVisual.height;
    ...
    visualTagClick: function visualTagClick(tag) {
    ...
    getVisualTagKey: function getVisualTagKey(tag) {
      return tag.x + '-' + tag.y + '-' + tag.width + '-' + tag.height;
    },
    changeScene: function changeScene(action, target) {
      var _this2 = this;
      ...
      var audioInLibrary = this.backgroundAudioLibrary.find(function (audio) {
        return audio.scenes.includes(nextScene.id);
      });
      var nextBackgroundAudio = audioInLibrary ? document.getElementById('background-audio-player-' + audioInLibrary.media.id) : null;

      if (this.backgroundAudio.playing) {
        this.fadeOutAudio(this.backgroundAudio.playing, function () {
          _this2.activeSceneIndex = nextSceneIndex;
          if (nextBackgroundAudio) {
            _this2.playAudio(nextBackgroundAudio);
            _this2.backgroundAudio.playing = nextBackgroundAudio;
          }
        });
        return;
      } else {
  ...
  components: {
    SubtitlingMachine: __WEBPACK_IMPORTED_MODULE_9__components_SubtitlingMachine___default.a
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_2__interfaces_knowsMarkdown__["a" /* default */]],
  metaInfo: function metaInfo() {
    return {
      title: '\u300A' + this.config.seriesTitle + '\u300B' + this.config.title + '\u2192\u6C83\u8349\u2190\u570B\u6703\u7121\u96D9',
      meta: [{
  ...
  computed: {
    ...
    widthConstraint: function widthConstraint() {
      return {
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(this.scripts.map(function (scriptURL) {
      return _this.loadScript(scriptURL);
    })).then(function (results) {
      if (window.plotdb) {
        window.plotdb.load(_this.chart.id, function (chart) {
          chart.attach(document.getElementById(_this.mountingPoint), {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    ...
    interactionSelectedOption: function interactionSelectedOption() {
    ...
    contributors: function contributors() {
      return [].concat(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_toConsumableArray___default()(new __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_set___default.a(this.raw.map(function (row) {
  ...
  mounted: function mounted() {
    ...
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()('[val=data-tally-country]').html(this.raw.filter(function (row) {
      return _this.$data.tally.country.condition(row.what + row.what_in_english);
    }).length);
    __WEBPACK_IMPORTED_MODULE_2_jquery___default()('[val=data-title]').html(this.config.title);
  },

  methods: {
    interactionSelectOption: function interactionSelectOption(event, selectionIndex) {
      if (!this.interaction.done) {
        this.interaction.selection = selectionIndex;
      }
    },
    interactionSubmit: function interactionSubmit(event) {
      if (!this.interaction.done && this.interaction.selection > -1) {
        this.interaction.done = true;
      }
    },
    markdown: function markdown(str) {
      return __WEBPACK_IMPORTED_MODULE_3_marked___default()(str);
    }
  },
  components: {
    Count: __WEBPACK_IMPORTED_MODULE_4__components_map_Count___default.a,
    Region: __WEBPACK_IMPORTED_MODULE_5__components_map_Region___default.a,
    World: __WEBPACK_IMPORTED_MODULE_6__components_map_World___default.a
  }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  props: ['config'],
  computed: {
    seriesImage: function seriesImage() {
      return __webpack_require__(42)("./" + this.config.image);
    }
  },
  components: {
    SeriesMenu: __WEBPACK_IMPORTED_MODULE_0__components_SeriesMenu___default.a
...
/* harmony default export */ __webpack_exports__["default"] = ({
  props: ['config'],
  computed: {
    seriesLink: function seriesLink() {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_0__interfaces_knowsTokenization__["a" /* default */]],
  ...
  methods: {
    play: function play() {
      ...
      this.tokenTimer = setInterval(function () {
        if (_this.lineTokens && _this.tokenIndex < _this.lineTokens.length) {
          _this.tokenIndex += 1;
        } else {
          _this.prepare();
        }
    ...
    prepare: function prepare() {
      ...
      this.lineTimer = setTimeout(function () {
        _this2.lineTimer = null;
        var nextLineIndex = _this2.lineIndex + 1;
        if (nextLineIndex >= _this2.lines.length) {
          _this2.stop();
        } else {
          _this2.lineIndex = nextLineIndex;
          _this2.tokenIndex = -1;
          if (_this2.lineIndex > -1) {
            _this2.play();
          } else {
            _this2.stop();
          }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [__WEBPACK_IMPORTED_MODULE_2__interfaces_knowsMarkdown__["a" /* default */], __WEBPACK_IMPORTED_MODULE_3__interfaces_knowsClasses__["a" /* default */]],
  metaInfo: function metaInfo() {
    return {
      title: '\u300A' + this.config.seriesTitle + '\u300B' + this.config.title + '\u2192\u6C83\u8349\u2190\u570B\u6703\u7121\u96D9',
      meta: [{
  ...
  data: function data() {
    ...
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(data, status, references);
  },
  ...
  computed: {
    ...
    activeCard: function activeCard() {
      return this.activeCardIndex >= 0 && this.activeCardIndex < this.cards.length ? this.cards[this.activeCardIndex] : undefined;
    },
  ...
  methods: {
    cardClasses: function cardClasses(index) {
      var classes = [];
      if (this.cards[index]) {
    ...
    swipeActionEnabled: function swipeActionEnabled(action) {
      return this.topCard && this.topCard.hasOwnProperty('options') && this.topCard.options.hasOwnProperty(action);
    },
    swipeActionClasses: function swipeActionClasses(action) {
      var classes = [];
    ...
    swipeActionTag: function swipeActionTag(action) {
    ...
    swipe: function swipe(direction) {
      if (direction !== 0 && this.topCard) {
        ...
        this.topCard.el.parentNode.appendChild(this.topCard.el);
  ...
  mounted: function mounted() {
    ...
    var config = {
      ...
      throwOutConfidence: function throwOutConfidence(xOffset, yOffset, element) {
        var xConfidence = Math.min(Math.abs(xOffset) / element.offsetWidth * 2, 1);
        var yConfidence = Math.min(Math.abs(yOffset) / element.offsetHeight * 2, 1);
        return Math.max(xConfidence, yConfidence);
      },
      throwOutDistance: function throwOutDistance() {
        return document.querySelector(_this.cardSelector).offsetWidth * 1.05 * (1 + window.innerWidth / 320 * 0.05);
      }
    };
    __WEBPACK_IMPORTED_MODULE_1_vue__["a" /* default */].set(this, 'stack', Swing.Stack(config));

    elements.reverse();
    elements.forEach(function (el, index) {
      _this.cards[_this.cards.length - index - 1].el = el;
      _this.cards[_this.cards.length - index - 1].obj = _this.stack.createCard(el);
      _this.mirror.unshift(index);
    });
    this.stack.on('dragstart', function (e) {
      var index = +e.target.dataset.cardIndex;
      if (_this.cards[index]) {
        _this.cards.forEach(function (cardStatus) {
          cardStatus.dragging = false;
        });
        _this.cards[index].dragging = true;
      }
      _this.activeCardIndex = index;
    });
    this.stack.on('dragmove', function (e) {
      var index = +e.target.dataset.cardIndex;
      if (_this.cards[index]) {
        _this.cards[index].offsetX = e.offset;
      }
    });
    this.stack.on('throwinend', function (e) {
      var index = +e.target.dataset.cardIndex;
      if (_this.cards[index]) {
        _this.cards[index].dragging = false;
        _this.cards[index].isOut = false;
        _this.cards[index].hasBeenOut = false;
      }
      if (_this.mirror.indexOf(index) < 0) {
        _this.mirror.push(index);
      }
    });
    this.stack.on('throwout', function (e) {
      _this.lastSwipe = e.throwDirection.toString().toLowerCase().indexOf('right') > -1 ? +1 : -1;
    });
    this.stack.on('throwoutend', function (e) {
      var index = +e.target.dataset.cardIndex;
      if (_this.cards[index]) {
        _this.cards[index].isOut = true;
      }

      _this.activeCardIndex = index;
      if (_this.cards[index].isOut === true && _this.cards[index].hasBeenOut === false) {
        var toRemove = _this.mirror.indexOf(index);
        if (toRemove >= 0 && toRemove < _this.mirror.length) {
          _this.mirror.splice(toRemove, 1);
        } else {
          console.error('broken mirror');
        }

        if (_this.cards[index].type === 'question') {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    drawPath: function drawPath(el, points, title) {
      ...
      try {
        for (var _iterator = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_get_iterator___default()(points), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    init: function init() {
      ...
      this.el.container = __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](this.$el).select('.chart');

      util.axes.x.values = this.rows.user.map(function (d) {
        return d.x;
      });
      util.axes.x.scale = __WEBPACK_IMPORTED_MODULE_5_d3__["f" /* scalePoint */]().domain(util.axes.x.values).range([size.p, size.w - size.p]);
      util.axes.y.scale = __WEBPACK_IMPORTED_MODULE_5_d3__["g" /* scaleLinear */]().domain([config.axes.y.min, config.axes.y.max]).range([size.h - size.p, 0 + size.p]);

      util.sequence.label.format = function (d) {
        return __WEBPACK_IMPORTED_MODULE_5_d3__["h" /* format */](config.sequence.label.formatString)(d / config.axes.y.divider);
      };

      util.line = __WEBPACK_IMPORTED_MODULE_5_d3__["i" /* line */]().x(function (d) {
        return util.axes.x.scale(d.x);
      }).y(function (d) {
        return util.axes.y.scale(d.y);
      });

      util.axes.x.axis = __WEBPACK_IMPORTED_MODULE_5_d3__["j" /* axisBottom */](util.axes.x.scale).tickSize(size.h - size.p * 2);
      util.axes.x.customize = function (g) {
        g.call(util.axes.x.axis);
        g.select('.domain').remove();
        g.selectAll('.tick').each(function (d, i, nodes) {
          var tick = __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](this);
          tick.select('line');
          ...
          if (d.indexOf('/') > -1) {
            var _d$split = d.split('/'),
                _d$split2 = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_slicedToArray___default()(_d$split, 2),
                y = _d$split2[0],
                m = _d$split2[1];

            var target = this.previousSibling;
            while (!!target && __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](target).datum().indexOf('/') < 0) {
              target = target.previousSibling;
            }
            if (!(!!target && __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](target).datum().indexOf(y) > -1)) {
          ...
          text.append('text').text(d + (!this.nextSibling ? config.axes.x.label : '')).attr('dy', 1 * size.rem);
        });
      };

      util.axes.y.format = function (d) {
        return __WEBPACK_IMPORTED_MODULE_5_d3__["h" /* format */](config.axes.y.formatString)(d / config.axes.y.divider);
      };
      util.axes.y.axis = __WEBPACK_IMPORTED_MODULE_5_d3__["k" /* axisRight */](util.axes.y.scale).tickSize(0).tickValues(this.config.axes.y.ticks).tickFormat(function (d) {
      ...
      util.axes.y.customize = function (g) {
        ...
        g.select('.tick:last-of-type').append('text').classed('unit-label', true).attr('dy', -1 * size.rem).text(config.axes.y.label);
      };
    },
    draw: function draw() {
      var _this = this;
      ...
      rectangles.enter().append('rect').merge(rectangles).attr('x', function (d) {
        return self.util.axes.x.scale(d.x);
      }).attr('y', this.util.axes.y.scale(this.config.axes.y.max)).attr('width', this.util.axes.x.scale.step()).attr('height', this.util.axes.y.scale(this.config.axes.y.min) - this.util.axes.y.scale(this.config.axes.y.max)).attr('fill', function (d) {
      ...
      this.rows.user.forEach(function (row, i, rows) {
        var _row$label$split = row.label.split('-'),
            _row$label$split2 = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_helpers_slicedToArray___default()(_row$label$split, 1),
            president = _row$label$split2[0];

        if (president !== lastPresident) {
          self.el.bg.append('text').text(presidents[president]).attr('class', 'president').attr('x', self.util.axes.x.scale(row.x)).attr('y', self.util.axes.y.scale(self.config.axes.y.max)).attr('dx', 0.25 * self.size.rem).attr('dy', 1.25 * self.size.rem);
        }
      ...
      this.el.button = __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](this.$el).select('.after > button').on('click', function () {
        ...
        __WEBPACK_IMPORTED_MODULE_5_d3__["b" /* select */](self.$el).select('.after').classed('reveal', true);
      });
      ...
      function redraw() {
        ...
        var m = __WEBPACK_IMPORTED_MODULE_5_d3__["l" /* mouse */](this);
        var x = m[0];
        var y = Math.max(self.size.p, Math.min(m[1], self.size.h - self.size.p));

        var start = self.util.axes.x.scale.range()[0];
        var step = self.util.axes.x.scale.step();
        var target;
      ...
      this.el.root.call(__WEBPACK_IMPORTED_MODULE_5_d3__["m" /* drag */]().on('drag', redraw));

      this.drawOrig();

      var lastOrig = this.rows.orig.filter(function (row, i) {
        return row.fix && i + 1 < _this.rows.orig.length && !_this.rows.orig[i + 1].fix;
      }).pop();

      var viewport = __WEBPACK_IMPORTED_MODULE_4_jquery___default()(window).width();
    ...
    markdown: function markdown(text) {
      return __WEBPACK_IMPORTED_MODULE_6_marked___default()(text);
    }
  }
});
  ...
  methods: {
    update: function update() {
      ...
      this.rows = this.raw.filter(function (row) {
        return _this.count.condition(row.what + row.what_in_english);
      });
    }
  }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3__ = __webpack_require__(153);




__WEBPACK_IMPORTED_MODULE_0_d3__["a" /* selection */].prototype.tightlyPack = function (options) {
  ...
  nodes.forEach(function (node) {
    ...
    var el = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* select */](node);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    update: function update() {
      ...
      this.el.container = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* select */](this.$el).select('.draw');
      this.el.root = this.el.container.select('svg');
      this.rows = this.raw.filter(function (row) {
        return row.region === _this.region.name;
      });
      this.draw();
    },
    draw: function draw() {
      ...
      this.score = this.rows.length > 0 ? Math.round(this.el.root.selectAll('g.quote.yes').size() / this.rows.length * 100) : 0;
...
__WEBPACK_IMPORTED_MODULE_2_d3__["a" /* selection */].prototype.centerCenter = function () {
  this.each(function (d) {
    var box = this.getBBox();
    var top = d.y - box.height / 2;
    var left = d.x - box.width / 2;
    __WEBPACK_IMPORTED_MODULE_2_d3__["b" /* select */](this).attr('transform', 'translate(' + [left, top].join(',') + ')');
  });
  return this;
};
__WEBPACK_IMPORTED_MODULE_2_d3__["a" /* selection */].prototype.makeLabel = function (options) {
  this.each(function (d) {
    var root = __WEBPACK_IMPORTED_MODULE_2_d3__["b" /* select */](this).classed('yes', /country|state|nation/.test(d.what + d.what_in_english));
    var el = root.append('a').attr('xlink:href', d.link).attr('target', '_blank');

    var rem = parseInt(root.style('font-size'));

    var offset = {
      x: options.padding.x,
      y: options.padding.y + 1 / options.lineHeight - 0.1 };
...
__WEBPACK_IMPORTED_MODULE_2_d3__["a" /* selection */].prototype.saveSize = function () {
  this.each(function (d) {
    var box = this.getBBox();
    d.width = box.width;
    d.height = box.height;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    init: function init() {
      ...
      var projection = __WEBPACK_IMPORTED_MODULE_2_d3__["c" /* geoMercator */]().scale(this.size.w / (2 * Math.PI)).translate([this.size.w / 2, this.size.h / 2 + this.util.offset.y]);
      this.util.projection = projection;

      this.el.container = __WEBPACK_IMPORTED_MODULE_2_d3__["b" /* select */](this.$el).select('.draw').classed('debug', this.debug);
      this.el.root = this.el.container.append('svg').attr('viewBox', [0, 0, this.size.w, this.size.h].join(' '));
    },
    update: function update() {
      var _this = this;

      this.rows = this.raw.map(function (row) {
        var pos = _this.util.projection([row.lng, row.lat]);
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(row, {
          x: pos[0],
          y: pos[1]
        });
    ...
    spread: function spread() {
      var self = this;
      var simulation = __WEBPACK_IMPORTED_MODULE_2_d3__["d" /* forceSimulation */]();
      simulation.force('collide', __WEBPACK_IMPORTED_MODULE_2_d3__["e" /* forceCollide */]().radius(function (d) {
    ...
    markdown: __WEBPACK_IMPORTED_MODULE_1_marked___default.a
  }
});
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "atlas-regions-region"
  }, [_c('div', {
    staticClass: "name"
  }, [_vm._v(_vm._s(_vm.region.translation))]), _vm._v(" "), _c('div', {
    staticClass: "score"
  }, [_c('span', {
    staticClass: "value"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  return _c('div', {
    staticClass: "atlas atlas-world"
  }, [_c('div', {
    staticClass: "draw"
  }), _vm._v(" "), _c('figcaption', [_c('a', {
    staticClass: "a-text",
    attrs: {
      "href": "https://s-media-cache-ak0.pinimg.com/originals/a4/dc/b3/a4dcb30b0ba3b5e26cc5b6788b98c625.jpg",
      "target": "_blank"
    }
  }, [_vm._v("Image Source")])])])
}]}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('article', {
    ...
    staticClass: "text textgroup"
  }, [_c('hgroup', [_c('h2', [_vm._v(_vm._s(_vm.config.seriesTitle))]), _vm._v(" "), _c('h1', [_vm._v(_vm._s(_vm.config.title))])]), _vm._v(" "), _c('div', {
    staticClass: "authorship"
  }, [_vm._l((_vm.authorship), function(item) {
    return _c('div', {
      staticClass: "item d-flex flex-row"
    }, [_c('div', {
      staticClass: "job"
    }, [_vm._v(_vm._s(item.job))]), _vm._l((item.people), function(person) {
      return _c('div', {
        staticClass: "person"
    ...
    staticClass: "person"
  }, [_vm._v(_vm._s(_vm.contributors))])])], 2), _vm._v(" "), _c('div', {
    staticClass: "date"
  }, [_vm._v(_vm._s(_vm.config.date))])])]), _vm._v(" "), _c('section', {
    staticClass: "question"
  }, [_c('div', {
    staticClass: "introduction textgroup",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.question.introduction))
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "content"
  }, [_c('blockquote', [_vm._v("Taiwan will be the first "), _c('em', {
    staticClass: "blank",
    domProps: {
      "innerHTML": _vm._s(_vm.interactionSelectedOption)
    }
  }), _vm._v(" in Asia to legalize same-sex marriage.")]), _vm._v(" "), _c('p', [_c('span', [_vm._v("翻譯：台灣會是亞洲第一個同性婚姻合法化的")]), _c('em', {
    staticClass: "blank",
    domProps: {
      "innerHTML": _vm._s(_vm.interactionSelectedOption)
    }
    ...
    class: _vm.interaction.type
  }, [_c('ul', {
    staticClass: "list-unstyled d-flex flex-wrap"
  }, _vm._l((_vm.interaction.options), function(option, index) {
    return _c('li', {
      key: option.name,
      staticClass: "d-flex flex-row",
      class: {
        selected: _vm.interaction.selection == index
      },
      attrs: {
        "id": 'interaction-option-' + option.name
      },
      on: {
        "click": function($event) {
          _vm.interactionSelectOption($event, index)
        }
      }
    }, [_c('div', {
      staticClass: "index"
    }, [_vm._v(_vm._s(_vm.circledDigits[index + 1]))]), _c('div', {
      staticClass: "value"
    }, [_vm._v(_vm._s(option.name))])])
  })), _vm._v(" "), _c('button', {
    staticClass: "musou",
    on: {
      "click": _vm.interactionSubmit
    }
  }, [_vm._v(_vm._s(_vm.question.go))])])]), _vm._v(" "), _c('div', {
    staticClass: "explanation textgroup",
    class: _vm.interaction.done ? 'visible' : 'hidden',
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.question.conclusion))
    }
  })]), _vm._v(" "), _c('section', {
    staticClass: "answers"
  }, [_c('div', {
    staticClass: "reminder",
    class: _vm.interaction.done ? 'd-none' : 'd-block'
  }, [_vm._v(_vm._s(_vm.reminder.description))]), _vm._v(" "), _c('div', {
    staticClass: "answer graph",
    class: _vm.interaction.done ? 'visible' : 'hidden'
  }, [_c('div', {
    staticClass: "textgroup"
  }, [_c('div', {
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.graphs.tally.title))])]), _vm._v(" "), _c('div', {
    staticClass: "description",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.graphs.tally.description))
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "atlas atlas-tally d-flex flex-wrap justify-content-around"
  }, _vm._l((_vm.tally), function(count, id) {
    return _c('count', {
      key: id,
      attrs: {
        "raw": _vm.raw,
    ...
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.graphs.regions.title))])]), _vm._v(" "), _c('div', {
    staticClass: "description",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.graphs.regions.description))
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "atlas atlas-regions d-flex flex-wrap"
    ...
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.graphs.world.title))])]), _vm._v(" "), _c('div', {
    staticClass: "description",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.graphs.world.description))
    }
  })]), _vm._v(" "), _c('world', {
    attrs: {
      "raw": _vm.raw,
    ...
    staticClass: "answer conclusion",
    class: _vm.interaction.done ? 'visible' : 'hidden'
  }, [_c('div', {
    staticClass: "textgroup"
  }, [_c('div', {
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.conclusion.title))])]), _vm._v(" "), _c('div', {
    staticClass: "description a-text-only",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.conclusion.description))
    }
  })])])]), _vm._v(" "), _c('section', {
    staticClass: "call"
  }, [_c('div', {
    ...
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.call_for_action.title))])]), _vm._v(" "), _c('div', {
    staticClass: "description a-text-only",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.call_for_action.description))
    }
  })])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
  ...
  }, [_c('h3', [_vm._v("重新設定密碼")]), _vm._v(" "), _c('div', {
    staticClass: "paragraphs small"
  }, [_c('p', {
    staticClass: "note"
  }, [_vm._v("這次不要再忘記囉。")])]), _vm._v(" "), _c('div', {
    staticClass: "field"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    staticClass: "park floating"
  }, [_vm._v("設定密碼")])])]) : _c('div', {
    staticClass: "after"
  }, [_c('div', {
    staticClass: "paragraphs tight"
  }, [_c('p', [_vm._v("密碼設定完成。")])])])])])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
  ...
  }, [_c('h3', [_vm._v("忘記密碼了嗎？")]), _vm._v(" "), _c('div', {
    staticClass: "paragraphs small"
  }, [_c('p', {
    staticClass: "note"
  }, [_vm._v("請回想成為草民時填入的Email。")])]), _vm._v(" "), _c('div', {
    staticClass: "field"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.registrationEmail),
      expression: "registrationEmail"
    }],
    staticClass: "full-width",
    attrs: {
      "type": "email",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.registrationEmail = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "field"
    ...
    staticClass: "paragraphs tight"
  }, [_c('p', [_vm._v("如果系統中有你剛剛填入的Email，我們已經將信寄出。請收信，並按照信件中的步驟重新設定密碼。")])])])])])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('article', {
    staticClass: "longform"
  }, [_c('div', {
    staticClass: "content",
    style: (_vm.chart.contentStyle)
  }, [_c('div', {
    staticClass: "credit"
  }, [_c('span', [_vm._v("This project is made possible by ")]), _c('a', {
    attrs: {
      "href": _vm.sourceLink,
      "target": "_blank"
    }
    ...
    staticClass: "loading"
  }, [_vm._v("載入中，請稍候⋯")]) : _vm._e(), _vm._v(" "), _c('div', {
    attrs: {
      "id": "chart"
    }
  })]), _vm._v(" "), _c('div', {
    ...
    staticClass: "text textgroup"
  }, [_c('hgroup', [_c('h5', [_vm._v(_vm._s(_vm.config.seriesTitle))]), _vm._v(" "), _c('span', {
    staticClass: "zhi"
  }, [_vm._v("之")]), _vm._v(" "), _c('h4', [_vm._v(_vm._s(_vm.config.title))])]), _vm._v(" "), _c('div', {
    staticClass: "authorship"
  }, _vm._l((_vm.authorship), function(item) {
    return _c('div', {
      staticClass: "item d-flex flex-row"
    ...
    staticClass: "date"
  }, [_vm._v(_vm._s(_vm.config.date))]), _vm._v(" "), (_vm.references.length > 0) ? _c('div', {
    staticClass: "references a-text-only"
  }, [_c('h5', [_vm._v("參考資料")]), _vm._v(" "), _c('ul', _vm._l((_vm.references), function(ref) {
    return _c('li', {
      domProps: {
        "innerHTML": _vm._s(_vm.markdown(ref))
      }
    })
  }))]) : _vm._e()])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }, [_vm._v(_vm._s(this.total) + "篇裡有" + _vm._s(this.rows.length) + "篇")]), _vm._v(" "), _c('div', {
    staticClass: "name"
  }, [_vm._v("稱台灣為" + _vm._s(_vm.count.name))])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "modal-dialog"
  }, [(!_vm.loggedOut) ? _c('div', {
    staticClass: "before"
  }, [_c('div', {
    staticClass: "paragraphs first"
  }, [_c('p', [_vm._v("😀 " + _vm._s(_vm.handle))]), _vm._v(" "), (_vm.firstEmail) ? _c('p', [_vm._v("📬 " + _vm._s(_vm.firstEmail))]) : _vm._e()]), _vm._v(" "), _c('button', {
    staticClass: "park floating",
    on: {
      "click": function($event) {
    ...
    staticClass: "paragraphs first last"
  }, [_c('p', [_vm._v("Live long and prosper. 🖖")])])])])])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('article', {
    ...
    staticClass: "description",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.config.description))
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "authorship"
  }, _vm._l((_vm.authorship), function(item) {
    ...
    staticClass: "graphs"
  }, _vm._l((_vm.graphs), function(config) {
    ...
    staticClass: "bridge"
  }, [_vm._v("畫完了，然後呢？")]), _vm._v(" "), _c('section', {
    staticClass: "conclusion textgroup"
  }, [_c('h2', {
    staticClass: "title"
  }, [_vm._v(_vm._s(_vm.conclusion.title))]), _vm._v(" "), _c('div', {
    staticClass: "description a-text-only",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.conclusion.description))
    }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "before textgroup"
  }, [_c('div', {
    staticClass: "title"
  }, [_c('h2', [_vm._v(_vm._s(_vm.config.text.title))])]), _vm._v(" "), _c('div', {
    staticClass: "text a-text-only",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.config.text.before))
    }
  })]), _vm._v(" "), _vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "after textgroup"
  }, [_c('button', {
    class: [_vm.channel.id]
  }, [_vm._v("不想畫啦")]), _vm._v(" "), _c('div', {
    staticClass: "score d-flex justify-content-center align-items-center"
  }, [_c('div', [_vm._v("畫的有")]), _c('div', {
    staticClass: "number"
  }, [_vm._v(_vm._s(_vm.score))]), _c('div', [_vm._v("分像呢")])]), _vm._v(" "), _c('div', {
    staticClass: "text a-text-only",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.config.text.after))
    }
  })])])
},staticRenderFns: [function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "modal-mask more-transparent wide",
    attrs: {
      "id": "modal-tos"
    },
    on: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('article', {
    ...
    class: _vm.swipeActionClasses('left'),
    on: {
      "click": function($event) {
        _vm.swipe(_vm.swipeActionEnabled('left') ? -1 : 0)
      }
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "swipe-action d-flex justify-content-center align-items-center",
    class: _vm.swipeActionClasses('right'),
    on: {
      "click": function($event) {
        _vm.swipe(_vm.swipeActionEnabled('right') ? +1 : 0)
      }
    }
  })])])]), _vm._v(" "), _c('header', {
    staticClass: "end"
    ...
    on: {
      "click": function($event) {
        if ($event.target !== $event.currentTarget) { return null; }
        _vm.showResult = _vm.showMore = false
      }
    }
  }, [_c('div', {
    staticClass: "result"
  }, [_c('div', {
    staticClass: "question paragraphs",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.activeCard.hasOwnProperty('recap') ? _vm.activeCard.recap : _vm.activeCard.question))
    }
  }), _vm._v(" "), _c('div', {
    staticClass: "answer",
    class: _vm.activeCard.answer
  }), _vm._v(" "), _c('div', {
    staticClass: "but paragraphs",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.activeCard.but))
    }
  ...
  }, [_vm._v("下一題謝謝")]), _vm._v(" "), _c('button', {
    staticClass: "flat musou",
    on: {
      "click": function($event) {
        _vm.showMore = true
      }
    }
  }, [_vm._v("繼續說下去")])])], 2)]) : _vm._e()])], 1)
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "series-link",
    attrs: {
      "to": _vm.seriesLink,
      "alt": _vm.config.title
    }
  }, [_c('img', {
    staticClass: "key-visual",
    attrs: {
      "src": _vm.seriesImage
    }
  })]), _vm._v(" "), _c('p', {
    staticClass: "description"
  }, [_vm._v(_vm._s(_vm.config.description))]), _vm._v(" "), _c('div', {
    staticClass: "pages"
  }, _vm._l((_vm.config.pages), function(page) {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('transition', {
    ...
    staticClass: "modal-dialog"
  }, [(!_vm.verificationEmailSent && !_vm.loginSuccessful && !_vm.requireEmailVerification) ? _c('div', {
    staticClass: "before accordion"
  }, [_c('div', {
    staticClass: "card",
    class: _vm.cardClasses('join')
  }, [_c('a', {
    ...
    on: {
      "click": function($event) {
        $event.stopPropagation();
        $event.preventDefault();
        _vm.activateCard('join')
      }
    }
  }, [_c('h3', [_vm._v("成為草民")])]), _vm._v(" "), _c('div', {
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.joinHandle),
      expression: "joinHandle"
    }],
    staticStyle: {
      "width": "12.5rem"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.joinHandle = $event.target.value
      }
    }
  }), _c('button', {
    staticClass: "park small floating",
    on: {
      "click": _vm.generateRandomHandle
    }
  }, [_vm._v("隨機")])]), _vm._v(" "), _c('div', {
    staticClass: "note"
  }, [_vm._v("草民代號是你在沃草共有地的身份識別，無法更改，請謹慎選擇。你可以使用A-Z、a-z（大小寫不同）、0-9、底線（_）以及連字號（-）。")]), _vm._v(" "), _c('div', {
    staticClass: "field"
  }, [_c('input', {
    directives: [{
      name: "model",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.joinEmail = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "field"
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.joinPassword),
      expression: "joinPassword"
    }],
    staticClass: "full-width",
    attrs: {
      "type": "password",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.joinPassword = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    ...
    domProps: {
      "checked": Array.isArray(_vm.iAgree) ? _vm._i(_vm.iAgree, null) > -1 : (_vm.iAgree)
    },
    on: {
      "change": function($event) {
        ...
        if (Array.isArray($$a)) {
          var $$v = null,
            $$i = _vm._i($$a, $$v);
          if ($$el.checked) {
            $$i < 0 && (_vm.iAgree = $$a.concat([$$v]))
          } else {
            $$i > -1 && (_vm.iAgree = $$a.slice(0, $$i).concat($$a.slice($$i + 1)))
          }
        } else {
          _vm.iAgree = $$c
        }
  ...
  }, [_vm._v("使用條款")])])])])])]), _vm._v(" "), _c('div', {
    staticClass: "card dark",
    class: _vm.cardClasses('login')
  }, [_c('a', {
    staticClass: "card-head",
    on: {
      "click": function($event) {
        $event.stopPropagation();
        $event.preventDefault();
        _vm.activateCard('login')
      }
    }
  }, [_c('label', {
    staticClass: "text-color-park"
  }, [_vm._v("已經有帳號了？")]), _vm._v(" "), _c('h3', [_vm._v("草民登入")])]), _vm._v(" "), _c('div', {
    staticClass: "card-body",
    on: {
      "keyup": function($event) {
        if (!('button' in $event) && _vm._k($event.keyCode, "enter", 13, $event.key)) { return null; }
    ...
    directives: [{
      name: "model",
      rawName: "v-model",
      value: (_vm.loginAccount),
      expression: "loginAccount"
    }],
    staticClass: "full-width",
    attrs: {
      "type": "text",
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.loginAccount = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "field"
    ...
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.showFacebookLogin($event)
      }
    }
  }, [_vm._v("你在找Facebook登入嗎？")])])])])]) : _c('div', {
    staticClass: "after"
  }, [(_vm.verificationEmailSent) ? _c('div', {
    staticClass: "paragraphs tight"
  }, [_c('p', [_vm._v("請收信，並按照信件中的步驟啟動認證流程")])]) : _vm._e(), _vm._v(" "), (_vm.loginSuccessful) ? _c('div', {
    staticClass: "paragraphs tight"
  }, [_c('p', [_vm._v("歡迎回到沃草共有地")])]) : _vm._e(), _vm._v(" "), (_vm.requireEmailVerification) ? _c('div', [_c('p', [_vm._v("你的Email尚未通過認證")]), _vm._v(" "), _c('button', {
    staticClass: "park floating",
    on: {
      "click": function($event) {
        $event.preventDefault();
        _vm.requestEmailVerification($event)
      }
    }
  }, [_vm._v("重發認證信")])]) : _vm._e()])])])])])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "subtitling-machine"
  }, [(_vm.lineText) ? _c('div', {
    staticClass: "line"
  }, [_c('span', {
    style: (_vm.textStyles)
  }, [_vm._v(_vm._s(_vm.lineText))])]) : _vm._e()])
},staticRenderFns: []}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "hello"
  }, _vm._l((_vm.menu), function(series) {
    return _c('section', {
      key: series.id
    }, [_c('series-menu', {
      attrs: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('article', {
    ...
    staticClass: "scene",
    class: _vm.activeSceneClasses
  }, [_c('div', {
    staticClass: "main-visual-container",
    style: (_vm.mainVisualContainerStyles)
  }, [(_vm.mainVisual) ? _c('div', {
    staticClass: "main-visual",
    class: _vm.mainVisual.type
  }, [(_vm.mainVisual.type === 'image') ? [_c('div', {
    staticClass: "content",
    style: (_vm.mainVisualContentStyles),
    attrs: {
      "id": "journey-main-visual-canvas"
    }
  })] : _vm._e()], 2) : _vm._e(), _vm._v(" "), (_vm.activeScene.visualTags) ? _c('div', {
    staticClass: "visual-tags",
    style: (_vm.visualTagContainerStyles)
  }, _vm._l((_vm.activeScene.visualTags), function(tag) {
    return _c('div', {
      key: _vm.getVisualTagKey(tag),
      staticClass: "visual-tag",
      style: (Object.assign(_vm.getPositions('visualTags', tag), _vm.getVisibility(tag))),
      on: {
        "click": function($event) {
          _vm.visualTagClick(tag)
        }
      }
    }, [_c('div', {
      staticClass: "region",
      style: (Object.assign(_vm.getDimensions('visualTags', tag), _vm.getStyles('visualTags', tag)))
    }), _vm._v(" "), (tag.content) ? _c('div', {
      staticClass: "content"
    }, [_vm._v(_vm._s(tag.content))]) : _vm._e()])
  })) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "subtitle d-flex justify-content-center"
  }, [_c('subtitling-machine', {
    key: _vm.activeScene.id,
    attrs: {
      "lines": _vm.activeScene.subtitle,
      "config": _vm.subtitling.config,
      "status": _vm.subtitling.status
    },
    on: {
      "update:status": function($event) {
        _vm.$set(_vm.subtitling, "status", $event)
      }
    }
  })], 1)]), _vm._v(" "), _c('div', {
    ...
    staticClass: "text"
  }, [(_vm.activeScene.date) ? _c('div', {
    staticClass: "date"
  }, [_c('span', [_vm._v(_vm._s(_vm.activeSceneDateString))]), (_vm.sequence.default.toggles.showCountdown) ? _c('span', {
    staticClass: "countdown"
  }, [_vm._v(_vm._s(_vm.activeSceneCountDown))]) : _vm._e()]) : _vm._e(), _vm._v(" "), (_vm.activeScene.beforeTitle) ? _c('h3', {
    staticClass: "before-title font-size-body body-style"
  }, [_c('span', [_vm._v(_vm._s(_vm.activeScene.beforeTitle))])]) : _vm._e(), _vm._v(" "), (_vm.activeScene.title) ? [(_vm.activeSceneClasses.includes('opening')) ? _c('h1', {
    staticClass: "title small"
  }, [_c('span', [_vm._v(_vm._s(_vm.activeScene.title))])]) : _c('h2', {
    staticClass: "title small"
  }, [_c('span', [_vm._v(_vm._s(_vm.activeScene.title))])])] : _vm._e(), _vm._v(" "), (_vm.activeScene.description) ? _c('div', {
    staticClass: "paragraphs",
    domProps: {
      "innerHTML": _vm._s(_vm.markdown(_vm.activeScene.description))
    }
  }) : _vm._e()], 2)])]), _vm._v(" "), _c('div', {
    staticClass: "control-panel d-flex"
  }, [_c('div', {
    staticClass: "previous",
    on: {
      "click": function($event) {
        _vm.changeScene('prev')
      }
    }
  }), _vm._v(" "), (_vm.activeSceneClasses.includes('fork')) ? _vm._l((_vm.activeScene.options), function(option) {
    return _c('div', {
      staticClass: "option",
      class: option.type,
      style: (_vm.getStyles('options', option)),
      on: {
        "click": function($event) {
          _vm.changeScene(option.action, option.target)
        }
      }
    ...
    on: {
      "click": function($event) {
        _vm.changeScene('next')
      }
    }
  })]], 2)]), _vm._v(" "), _c('div', {
    staticClass: "background-audio-library"
  }, _vm._l((_vm.backgroundAudioLibrary), function(audio) {
    return _c('audio', {
      attrs: {
        "id": 'background-audio-player-' + audio.media.id,
        "src": audio.media.url
      }
    })
  })), _vm._v(" "), _c('header', {
    ...
    staticClass: "zhi"
  }, [_vm._v("之")]), _vm._v(" "), _c('h4', [(_vm.config.beforeTitle) ? _c('span', {
    staticClass: "before-title font-size-body body-style"
  }, [_vm._v(_vm._s(_vm.config.beforeTitle))]) : _vm._e(), _c('span', [_vm._v(_vm._s(_vm.config.title))])])]), _vm._v(" "), _c('div', {
    staticClass: "authorship"
  }, _vm._l((_vm.authorship), function(item) {
    return _c('div', {
      staticClass: "item d-flex flex-row"
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('main', [_c('NavigationWithIdentity', {
    attrs: {
      "channel": _vm.channel
    }
  ...
  }), _vm._v(" "), (_vm.modalAuthIsShown) ? _c('ModalAuth') : _vm._e(), _vm._v(" "), (_vm.modalLostPwdIsShown) ? _c('ModalLostPwd') : _vm._e(), _vm._v(" "), (_vm.modalResetPwdIsShown) ? _c('ModalResetPwd') : _vm._e(), _vm._v(" "), (_vm.modalIdentityIsShown) ? _c('ModalIdentity') : _vm._e(), _vm._v(" "), (_vm.modalTermsOfSvcIsShown) ? _c('ModalTermsOfSvc') : _vm._e(), _vm._v(" "), _c('FooterStandard'), _vm._v(" "), (_vm.supportIsShown) ? _c('SupportWatchoutStandard', {
    attrs: {
      "support-is-shown": _vm.supportIsShown,
      "support-package-key": _vm.supportPackageKey
    },
    on: {
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('nav', {
    staticClass: "navbar sticky-top d-flex flex-row",
    class: _vm.channel.classes.bg
  }, [_c('router-link', {
    staticClass: "navbar-brand",
    class: _vm.channelButtonClasses,
    attrs: {
      "to": {
        path: '/'
      }
  ...
  }, _vm._l((_vm.menu), function(group) {
    return _c('el-submenu', {
      ...
      slot: "title"
    }, [_vm._v(_vm._s(group.name))]), _vm._v(" "), _vm._l((group.pages), function(page) {
    ...
    class: _vm.identityButtonClasses,
    attrs: {
      "id": "navbar-identity"
    },
    on: {
...
//# sourceMappingURL=app.6768fc7c03ceece87ae2.js.map